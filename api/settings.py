...
SECRET_KEY = '$j_-orthvff_wwd26ze^rif^(x4c%tsj0%=(^v=wix-pn9!j8a'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'chunyu',                     # Your db name, Or path to database file if using sqlite3
        'USER':'root',                        # Your db user name, Not used with sqlite3
        'PASSWORD':'chunyu520',     #  Your db password, Not used with sqlite3
